...
class LoginPage extends React.Component<{ searchParams: Message }> {
  private async signIn(formData: FormData) {
    "use server";
      ...
      <form className="flex-1 flex flex-col w-full justify-center gap-2 text-foreground [&>input]:mb-6 max-w-md p-4">
        ...
        <div className="flex flex-col gap-2 [&>input]:mb-3 mt-8">
          ...
          <Input
            ...
            required
          />
          <SubmitButton formAction={this.signIn} pendingText="Signing In...">
            Log in
          </SubmitButton>
          <FormMessage message={this.props.searchParams} />
        </div>
      </form>
    );
  }
